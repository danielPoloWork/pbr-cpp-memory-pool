...
**Status check:** As of 2026-06-10 — Milestone 0 complete; Milestone 1 nearly complete (items 1.1–1.13, 1.15 closed); item 1.14 is the final release PR that closes Milestone 1 and produces the `v0.1.0` tag.
