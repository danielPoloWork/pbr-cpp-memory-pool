...
How `README.md`, `ROADMAP.md`, `docs/specs/`, and `docs/adr/` stay current as the project evolves. The short version is in [`AGENTS.md`](../../AGENTS.md) §6; this document is the operational guide.
